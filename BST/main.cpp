...
int main()
{
	...
	StudentData* moreStu2 = new StudentData(11113333, "New student", "New Major", 2.6, 124, 3, 14);
	stu.addTop(*moreStu2);

	stu_tree.add(stu.get_node_data(*moreStu2).getID(), stu.get_node_address(*moreStu2));
